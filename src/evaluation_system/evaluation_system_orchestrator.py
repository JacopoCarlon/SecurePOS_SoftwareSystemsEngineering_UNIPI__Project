...
class EvaluationSystemOrchestrator:
    ...
    def __init__(self):
        ...
        self.config_path = f'{data_folder}/evaluation_system/configs/eval_config.json'
        self.config_schema_path = f'{data_folder}/evaluation_system/configs/eval_config_schema.json'
        self.config = None
    ...
    def load_config(self):
        ...
        with open(self.config_schema_path, "r", encoding="UTF-8") as file:
            ev_config_schema = json.load(file)
        if not validate_json(ev_config, ev_config_schema):
        ...
        self.config_schema = ev_config_schema
